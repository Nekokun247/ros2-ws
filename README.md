...
alias ros2-rebuild='docker compose -f docker/compose.pc.yaml down && docker image prune -f && docker compose -f docker/compose.pc.yaml build --no-cache && docker compose -f docker/compose.pc.yaml up -d'
# Dừng container
